...
ASPOSE_DLL_DIRECTORY=r"C:\Users\hanih\Documents\yellowsys\convertor-final\convertor-final\bin\Release\net7.0\win-x64\publish"
dlls = [
    "Aspose.Words.dll",
    # "Aspose.Cells.dll",
    "Aspose.Slides.dll",
...
class Converter:
    ...
    def apply_license(self):
        # Words
        Aspose.Words.License().SetLicense(self._license_path)

        # Slides
        Aspose.Slides.License().SetLicense(self._license_path)
...
print("done")
converter.convert_to_pdf(r"C:\Users\hanih\Documents\yellowsys\aspose\examples\9anoungypt.pptx", r"C:\Users\hanih\Documents\yellowsys\aspose\9anoungypt.pdf" )
